...
namespace GameHelper.Settings
{
    ...
    public class State
    {
        ...
        /// <summary>
        ///     Gets the selected ImGui visual theme.
        /// </summary>
        public AppTheme Theme = AppTheme.NeonGlass;
        ...
        /// <summary>
        ///     Gets or sets a value indicating whether lightweight hitch detector is enabled.
        /// </summary>
        public bool ShowHitchDetector = true;

        /// <summary>
        ///     Frame time threshold in milliseconds used to mark a hitch.
        /// </summary>
        public int HitchDetectorThresholdMs = 33;
        ...
        /// <summary>
        ///     Loads TGT tile locations on area change. Required for Radar TGT/POI icons,
        ///     but can cause a visible one-frame hitch when entering large areas.
        /// </summary>
        public bool LoadTgtTileData = true;
