...
namespace GameHelper.Utils
{
    ...
    public static class JsonHelper
    {
        ...
        public static void SafeToFile(object classObject, FileInfo file)
        {
            ...
            SafeTextToFile(content, file);
        }

        /// <summary>
        ///     Saves pre-serialized JSON/text into the file atomically.
        /// </summary>
        /// <param name="content">content to save in the file.</param>
        /// <param name="file">file to save in.</param>
        public static void SafeTextToFile(string content, FileInfo file)
        {
            file.Directory?.Create();
