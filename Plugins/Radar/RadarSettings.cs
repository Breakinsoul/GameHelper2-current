...
namespace Radar
{
    ...
    public sealed class RadarSettings : IPSettings
    {
        ...
        /// </summary>
        public bool DrawWhenNotPaused = false;
        ...
        /// </summary>
        public Vector4 WalkableMapColor = new(0.5882353f, 0.5882353f, 0.5882353f, 0.22352941f);
        ...
        /// <summary>
        /// Smooths dynamic entity icon positions on minimap and large map.
        /// </summary>
        public bool InterpolatePositions = true;

        /// <summary>
        /// Interpolation rate for dynamic entity icon positions. Higher values follow the raw position faster.
        /// </summary>
        public int InterpolationRate = 220;
        ...
        /// <summary>
        /// Draws the Radar diagnostic window with projection and visibility state.
        /// </summary>
        public bool ShowDebugOverlay = false;

        /// <summary>
        /// Draws synthetic test icons around the player to isolate projection/culling issues.
        /// </summary>
        public bool DrawTestIcons = false;

        /// <summary>
        /// Draws simple circles at projected entity positions, bypassing icon textures.
        /// </summary>
        public bool DrawDebugPrimitives = false;

        /// <summary>
        /// Draws tiny separate markers for on-death and ground-on-death effects.
        /// </summary>
        public bool ShowOnDeathEffectMarkers = true;

        /// <summary>
        /// Pixel radius for tiny on-death effect markers.
        /// </summary>
        public float OnDeathEffectMarkerRadius = 1.512f;

        /// <summary>
        /// Draws high-contrast vector marker frames behind minimap/large-map icons.
        /// </summary>
        public bool UseEnhancedIconMarkers = true;

        /// <summary>
        /// Keeps the original sprite icon inside the enhanced marker frame.
        /// </summary>
        public bool ShowOriginalIconTexture = true;

        /// <summary>
        /// Shape used by enhanced markers.
        /// </summary>
        public RadarMarkerShape EnhancedMarkerShape = RadarMarkerShape.Diamond;

        /// <summary>
        /// Multiplier applied to each icon's configured IconScale for marker frame size.
        /// </summary>
        public float EnhancedMarkerScale = 0.75f;

        /// <summary>
        /// Border thickness for enhanced markers.
        /// </summary>
        public float EnhancedMarkerBorderThickness = 1f;

        /// <summary>
        /// Alpha of the dark marker background.
        /// </summary>
        public int EnhancedMarkerBackgroundAlpha = 0;

        /// <summary>
        /// Shows the entities that were drawn by Radar in the current render pass.
        /// </summary>
        public bool ShowDrawnEntitiesTable = false;
        ...
        public List<string> DisabledEntityPathFilters = new()
        {
            ...
            "Metadata/Effects/PermanentServerEffect",
            "Metadata/MiscellaneousObjects/Doodad",
            "Metadata/MiscellaneousObjects/WorldItem",
            "Metadata/Effects/PermanentEffect",
            "Metadata/Effects/PlayerEffects/DexIntFourBEffect",
            "Metadata/Characters/DexInt/DexIntFourb",
            "Metadata/Monsters/Goblins/GoblinMiner/GoblinMinerMining@79",
            "Metadata/Chests/StackedBoulder03",
            "Metadata/Monsters/LeagueExpeditionNew/RuneEncounterController@79",
            "Metadata/MiscellaneousObjects/Expedition/ExpeditionDetonator",
            "Metadata/MiscellaneousObjects/Expedition2/Expedition2Encounter",
            "Metadata/Effects/ServerEffect",
            "Metadata/NPC/League/Ritual/Aoife",
            "Metadata/Chests/StackedBoulder04",
            "Metadata/Chests/GoblinRockPile03",
            "Metadata/Effects/Spells/ground_effects/VisibleServerGroundEffect",
            "Metadata/MiscellaneousObjects/Environment/WaveSprayEmitterPoint",
            "Metadata/Terrain/Gallows/Leagues/Expedition/Objects/ExpeditionSubareaEntrance",
            "Metadata/Terrain/Gallows/Act2/2_2/Objects/FallingDebris",
            "Metadata/Terrain/Gallows/Leagues/Expedition/Logbook_Basin/Objects/AntSpawnerProxxy",
            "Metadata/Terrain/Gallows/Leagues/Expedition/Logbook_Basin/Objects/FaridunExplosive",
            "Metadata/Terrain/Gallows/Leagues/Expedition/Logbook_Basin/Objects/OilWell",
            "Metadata/Critters/Beetle/Beetle",
            "Metadata/Critters/Scorpion/Yellow",
            "Metadata/Terrain/Gallows/Act4/4_4_1/Objects/TotemWall",
            "Metadata/Projectiles/PorcupineAntSpikeballSpikes",
            "Metadata/Terrain/Tools/AudioTools/G4_4_1/HinekorasPassageSinkHoleAudio",
            "Metadata/Critters/BloodWorm/BloodWorm",
            "Metadata/Terrain/Gallows/Act4/4_3_2/Objects/JellyLightLarge",
            "Metadata/Terrain/Gallows/Act4/4_3_2/Objects/JellyLightMedium",
            "Metadata/Terrain/Gallows/Act4/4_3_2/Objects/JellyLightSmall",
            "Metadata/Terrain/Tools/AudioTools/G4_3_2/SirenSingingCaveAudio",
            "Metadata/Critters/Crab/CrabCritterVariant03",
            "Metadata/Critters/Weta/Basic",
            "Metadata/Terrain/Gallows/Leagues/StoneCircle/Objects/RuneRock",
            "Metadata/Terrain/Leagues/Ritual/BloodPool",
            "Metadata/Terrain/Leagues/Ritual/RitualRuneInteractable",
            "Metadata/Terrain/Leagues/Ritual/RitualRuneLight",
            "Metadata/Monsters/JellfishNettler/JellyfishNettlerFlying@79",
            "Metadata/Projectiles/BloodMageBloodProjectile",
            "Metadata/Projectiles/BoneRabbleEagle",
            "Metadata/Terrain/Gallows/Leagues/Delirium/Objects/DeliriumInitiator",
            "Metadata/Projectiles/AfflictionBossLightningSmall",
            "Metadata/Monsters/LeagueDelirium/DoodadDaemons/DoodadDaemonShardPack1@79",
        };
        ...
        /// <summary>
        /// Icons for tormented spirit monsters.
        /// </summary>
        public Dictionary<string, IconPicker> TormentedSpiritIcons = new();
        ...
        public void DrawPOIMonsterSettingToImGui(string dllDirectory)
        {
            if (ImGui.TreeNode($"Monster POI Icons"))
            {
                ...
                foreach (var poimonster in this.POIMonsters.ToArray())
                {
        ...
        public void OtherImportantObjectsSettingToImGui(string dllDirectory)
        {
            if (ImGui.TreeNode($"Special Objects Icons"))
            {
                ...
                foreach (var obj in this.OtherImportantObjects.ToArray())
                {
        ...
        public void AddDefaultIcons(string dllDirectory)
        {
            ...
            this.AddDefaultTormentedSpiritIcons(Path.Join(dllDirectory, "tormented_spirit.png"));
        }
        ...
        private void AddDefaultTormentedSpiritIcons(string iconPathName)
        {
            this.TormentedSpiritIcons.TryAdd("Tormented Spirit", new IconPicker(iconPathName, 0, 0, 20, IconSize));
        }
    }
}
