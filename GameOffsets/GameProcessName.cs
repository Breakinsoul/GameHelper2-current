namespace GameOffsets
{
    ...
    public struct GameProcessDetails
    {
        ...
        {
            { "PathOfExile", "Path of Exile 2" }, // also works on Garena
            { "PathOfExile_KG", "Path of Exile 2" },
            { "PathOfExileSteam", "Path of Exile 2" },
            { "PathOfExile_x64", "Path of Exile 2" },
            { "PathOfExileEGS", "Path of Exile 2" }
        };
    }
}
